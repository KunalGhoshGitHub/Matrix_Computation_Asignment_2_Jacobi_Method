\documentclass[11pt]{article}
    ...
    % Document parameters
    % Document title
    \title{Kunal\_Ghosh\_AE\_291\_Assignment\_2}
...
\hypertarget{solving-2d-poissons-problem-using-jacobi-iterative-method}{%
\subsection{Solving 2D Poisson's problem using Jacobi iterative
method}\label{solving-2d-poissons-problem-using-jacobi-iterative-method}}
...
when}{Take the initial guess as u\^{}\{(0)\} = 0. Consider three mesh intervals: h = 1/10, h = 1/20 and h = 1/40. The iterations should be continued until the relative change in the solution u from one iteration to another is less than 10\^{}\{-8\} . More precisely, stop the iterations when}}\label{take-the-initial-guess-as-u0-0.-consider-three-mesh-intervals-h-110-h-120-and-h-140.-the-iterations-should-be-continued-until-the-relative-change-in-the-solution-u-from-one-iteration-to-another-is-less-than-10-8-.-more-precisely-stop-the-iterations-when}}
    ...
    \hypertarget{submit-a-short-report-where-for-each-h}{%
\subsection{Submit a short report, where, for each
h,}\label{submit-a-short-report-where-for-each-h}}

    \hypertarget{plot-the-relative-error-lhs-of-eq.-3-versus-the-iteration-index-k.-in-the-plot-the-relative-error-should-be-in-base-10-logarithmic-scale-for-example-see-the-command-semilogy-in-matlab.-report-the-number-of-iterations-required-to-arrive-at-the-convergence-criteria-given-in-eq.-3}{%
\subsection{1. Plot the relative error (LHS of Eq. 3) versus the
iteration index (k). In the plot, the relative error should be in
base-10 logarithmic scale (For example, see the command ''semilogy'' in
matlab). Report the number of iterations required to arrive at the
convergence criteria given in Eq.
3}\label{plot-the-relative-error-lhs-of-eq.-3-versus-the-iteration-index-k.-in-the-plot-the-relative-error-should-be-in-base-10-logarithmic-scale-for-example-see-the-command-semilogy-in-matlab.-report-the-number-of-iterations-required-to-arrive-at-the-convergence-criteria-given-in-eq.-3}}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k}{def} \PY{n+nf}{Jacobi\PYZus{}Solver}\PY{p}{(}\PY{n}{u}\PY{p}{,}\PY{n}{U}\PY{p}{,}\PY{n}{Error}\PY{p}{,}\PY{n}{Tolerance}\PY{p}{,}\PY{n}{f}\PY{p}{,}\PY{n}{x}\PY{p}{,}\PY{n}{y}\PY{p}{)}\PY{p}{:}
\PY{+w}{    }\PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
\PY{l+s+sd}{    Jacobi\PYZus{}Solver(u,U,Error,Tolerance,f,x,y): Solves the given poisson equation using the Jacobi method}
    ...
    \PY{k}{while} \PY{n}{temp} \PY{o}{\PYZgt{}}\PY{o}{=} \PY{n}{Tolerance}\PY{p}{:}
        ...
        \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,}\PY{n}{u}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{:}
            ...
            \PY{k}{for} \PY{n}{j} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,}\PY{n}{u}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{:}
                ...
                \PY{c+c1}{\PYZsh{} Jacobi Iteration step}
                \PY{n}{u\PYZus{}new}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{[}\PY{n}{j}\PY{p}{]} \PY{o}{=} \PY{l+m+mf}{0.25}\PY{o}{*}\PY{p}{(}\PY{n}{u}\PY{p}{[}\PY{n}{i}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{[}\PY{n}{j}\PY{p}{]} \PY{o}{+} \PY{n}{u}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{[}\PY{n}{j}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{]} \PY{o}{+} \PY{n}{u}\PY{p}{[}\PY{n}{i}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{[}\PY{n}{j}\PY{p}{]} \PY{o}{+} \PY{n}{u}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{[}\PY{n}{j}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]} \PY{o}{\PYZhy{}} \PY{p}{(}\PY{p}{(}\PY{n}{h}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2}\PY{p}{)}\PY{o}{*}\PY{n}{f}\PY{p}{(}\PY{n}{x}\PY{p}{[}\PY{n}{i}\PY{p}{,}\PY{n}{j}\PY{p}{]}\PY{p}{,}\PY{n}{y}\PY{p}{[}\PY{n}{i}\PY{p}{,}\PY{n}{j}\PY{p}{]}\PY{p}{)}\PY{p}{)}\PY{p}{)}
        
        \PY{c+c1}{\PYZsh{} Calculating the relative error}
        \PY{n}{temp} \PY{o}{=} \PY{n}{Error\PYZus{}Function}\PY{p}{(}\PY{n}{u\PYZus{}new}\PY{p}{,}\PY{n}{u}\PY{p}{)}
        
        \PY{c+c1}{\PYZsh{} Storing the errors corresponding to each iteration}
        \PY{n}{error}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{temp}\PY{p}{)}
        
    \PY{c+c1}{\PYZsh{} Storing u in the dictionary}
    \PY{n}{U}\PY{p}{[}\PY{n}{h}\PY{p}{]} \PY{o}{=} \PY{n}{u\PYZus{}new}
    
    \PY{c+c1}{\PYZsh{} Storing error in the dictionary}
...
\PY{k}{for} \PY{n}{h} \PY{o+ow}{in} \PY{n}{H}\PY{p}{:}
    ...
    \PY{c+c1}{\PYZsh{} Solving the system of equation using Jacobi\PYZsq{}s Method}
    \PY{n}{Jacobi\PYZus{}Solver}\PY{p}{(}\PY{n}{u}\PY{p}{,}\PY{n}{U}\PY{p}{,}\PY{n}{Error}\PY{p}{,}\PY{n}{Tolerance}\PY{p}{,}\PY{n}{f}\PY{p}{,}\PY{n}{X}\PY{p}{,}\PY{n}{Y}\PY{p}{)}
    
    \PY{n}{iteraions} \PY{o}{=} \PY{n+nb}{len}\PY{p}{(}\PY{n}{Error}\PY{p}{[}\PY{n}{h}\PY{p}{]}\PY{p}{)}
    
    \PY{n+nb}{print}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{h: }\PY{l+s+si}{\PYZob{}}\PY{n}{h}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
...
\PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Relative Error vs Iteration index (k)}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
...
\PY{k}{for} \PY{n}{h}\PY{p}{,}\PY{n}{u} \PY{o+ow}{in} \PY{n}{U}\PY{o}{.}\PY{n}{items}\PY{p}{(}\PY{p}{)}\PY{p}{:}
    ...
    \PY{n}{ax}\PY{o}{.}\PY{n}{set\PYZus{}title}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{h = }\PY{l+s+si}{\PYZob{}}\PY{n}{h}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
...
\end{tcolorbox}
    ...
    \hypertarget{contour-plots-of-the-solution-for-different-h}{%
\section{Contour Plots of the solution for different
h:}\label{contour-plots-of-the-solution-for-different-h}}

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{20}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{levels} \PY{o}{=} \PY{l+m+mi}{25}
\PY{k}{for} \PY{n}{h}\PY{p}{,}\PY{n}{u} \PY{o+ow}{in} \PY{n}{U}\PY{o}{.}\PY{n}{items}\PY{p}{(}\PY{p}{)}\PY{p}{:}
    \PY{n}{plt}\PY{o}{.}\PY{n}{contourf}\PY{p}{(}\PY{n}{X\PYZus{}Y\PYZus{}dict}\PY{p}{[}\PY{n}{h}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,} \PY{n}{X\PYZus{}Y\PYZus{}dict}\PY{p}{[}\PY{n}{h}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,}\PY{n}{u}\PY{p}{,}\PY{n}{levels}\PY{p}{)}
    ...
    \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{h = }\PY{l+s+si}{\PYZob{}}\PY{n}{h}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}  
    \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\PY{k}{for} \PY{n}{h}\PY{p}{,}\PY{n}{u} \PY{o+ow}{in} \PY{n}{U}\PY{o}{.}\PY{n}{items}\PY{p}{(}\PY{p}{)}\PY{p}{:}
    ...
    \PY{n}{ax}\PY{o}{.}\PY{n}{set\PYZus{}zlabel}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{u}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
    \PY{n}{ax}\PY{o}{.}\PY{n}{set\PYZus{}title}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{h = }\PY{l+s+si}{\PYZob{}}\PY{n}{h}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
    \PY{n}{ax}\PY{o}{.}\PY{n}{set\PYZus{}box\PYZus{}aspect}\PY{p}{(}\PY{n}{aspect}\PY{o}{=}\PY{k+kc}{None}\PY{p}{,} \PY{n}{zoom}\PY{o}{=}\PY{l+m+mf}{0.8}\PY{p}{)}
    \PY{n}{ax}\PY{o}{.}\PY{n}{patch}\PY{o}{.}\PY{n}{set\PYZus{}edgecolor}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{black}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}  
    \PY{n}{ax}\PY{o}{.}\PY{n}{patch}\PY{o}{.}\PY{n}{set\PYZus{}linewidth}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{)}  
\PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
